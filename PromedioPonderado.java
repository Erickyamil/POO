...
public class PromedioPonderado {
    public static void main(String[] args){
        ...
        System.out.print("Cuantas materias cursa: ");
        int tamaño = entrada.nextInt();
        int [] arrayCreditos = new int[tamaño];
        double [] arrayCalif = new double[tamaño];
        double [] arrayTotal = new double[tamaño];
    ...
    //Metodos encargados de guardar las calificaciones ingresadas por el usuario.
    ...
    //Metodos encargados de sumar todos los valores de un arreglo.
